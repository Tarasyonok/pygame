...
back_to_manu_button = Button(screen_width // 2, screen_height // 2, game_images.subsurface(492, 268, 79, 27))
start_button = Button(screen_width // 2, screen_height // 2, game_images.subsurface(484, 426, 79, 27))
...
while run:
    ...
    for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1 \
               and flying == False and game_over == False and main == False:
                flying = True
